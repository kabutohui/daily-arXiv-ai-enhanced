...
## 基础仓库 URL
https://kabutohui.github.io/daily-arXiv-ai-enhanced/
...
## 样例
```
bash scripts/fetch.sh "https://kabutohui.github.io/daily-arXiv-ai-enhanced/?category=cs.CV&author=Smith&keywords=deep"
```
